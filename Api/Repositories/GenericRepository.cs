...
{
    public abstract class GenericRepository<T> : IRepository<T>, IDisposable where T : BaseEntityforApiV1
    {
        protected readonly TFOMSContext _сontextFactory;
        private bool _disposedValue;
        protected GenericRepository(TFOMSContext contextFactory)
        {
